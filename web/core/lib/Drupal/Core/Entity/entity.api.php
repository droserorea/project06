 ...
 * and Views). For nodes, see @param \Drupal\Core\Entity\EntityInterface $entity
 ...
 *
 * @link node_access Node access rights @endlink for
 ...
 * @ingroup entity_crud
 *
 * @link themeable Default theme implementations topic @endlink and
