...
class Registry implements DestructableInterface
{
   ...
   *
   * See the @return \Drupal\Core\Utility\ThemeRegistry
   *   The build theme registry.
   *
   * @link themeable Default theme implementations topic @endlink for
   * details.
   *
   ...
   * @link themeable Theme system overview topic @endlink for
